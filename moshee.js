console.log("hello mosh 1");
console.log("hello mosh 2");

for (let mosh = 1; mosh <=10; mosh++) {
    console.log(mosh);
}

/*for ( mos = 1; mos <=10; mos++) {
    console.log(mos);
}*/

console.log(1+5 * 11-3); // לפי סדר פעולות מתמטיקה הוא חישב
    console.log("mosh + good");
